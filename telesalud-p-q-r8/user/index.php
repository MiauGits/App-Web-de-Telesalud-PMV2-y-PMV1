...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if($id) {
    ...
    if($resultadoQueryEliminar) {
      header('Location: /user?exitoGamma=3');
    }
  }
}
/* ========== NUEVO LEER FIN ========== */
...
<main class="contenedor">
      ...
      <?php while ($showCita = mysqli_fetch_assoc($selectLeerCita)) : ?>
        <tr>
          ...
          <td> <!-- Botón de ver receta INICIO -->
            ...
            <?php } else { ?>
              <a href="/user/citas/receta-vista.php?idreceta=<?php echo $showCita['tbl_receta_id_receta'] ?>" class="btn-ver">Ver receta</a>
            <?php }
            ?>
  ...
  <div class="nav-under-crud">
    ...
    <a class="btn-crud1" href="/agendar1.php">Agendar una nueva cita</a>
  </div>
</main>
