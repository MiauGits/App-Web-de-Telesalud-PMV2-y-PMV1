...
$espta_contrasena = '';
$espta_descripcion = '';
$tbl_especialidad_id_especialidad = '';
...
if($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if(empty($erroresAnadirEspecialista)) {
    ...
    $queryAnadirEspecialista = "INSERT INTO tbl_especialista (
      espta_nombres,
      espta_appaterno,
      espta_apmaterno,
      espta_correo,
    ...
    $insertQueryAnadirEspecialista = mysqli_query($db, $queryAnadirEspecialista);

    if($insertQueryAnadirEspecialista) {
      header('Location: /admin/especialistas?exitoBeta=1');
    }
...
<main class="contenedor">
  ...
  <form class="formulario" method="POST" action="/admin/especialistas/especialistas-crud/crear.php">
    ...
    <div class="nav-under-crud">
      ...
      <input class="btn-crud2" type="submit" value="Añadir especialista">
